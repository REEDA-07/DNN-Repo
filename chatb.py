...
st.markdown("<h4 style = 'margin: -30px; color: #280274; text-align: center; font-family: Copperplate Gothic'> Built by REEDA: DAINTREE COHORT </h4>", unsafe_allow_html = True)
...
with robot_image:
    robot_image.image('pngwing.com (7).png',width = 500, caption = 'I reply all your questions')
